...
document.getElementById('add-to-cart-form').addEventListener('submit', e => {
    ...
    // Aquí puedes cambiar el mensaje o implementar funcionalidad real de carrito
    alert(`Consulta enviada para ${quantity} unidad${quantity > 1 ? 'es' : ''} de "${productName}". Te contactaremos pronto para confirmar disponibilidad.`);
});
